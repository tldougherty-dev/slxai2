            ...
            <div className="border-2 border-electric-blue rounded-lg p-4 shadow-xl bg-white">
              ...
              <div className="text-center text-gray-700 dark:text-white">
                <p>
                  ...
                  <strong>Conference Hours:</strong> 8:45 AM to 5:10 PM (see summit schedule)
                </p>
              </div>
            </div>
                ...
                <div className={`grid ${isLandscape ? 'grid-cols-3' : 'grid-cols-1'} md:grid-cols-2 lg:grid-cols-3 gap-4`}>
                  {summitMembers.map((member) => (
                    <Link
                      ...
                      className="block flow-root p-4 border border-electric-blue/20 dark:border-electric-blue/30 rounded-lg bg-electric-blue/5 dark:bg-electric-blue/10 backdrop-blur-sm hover:bg-electric-blue/10 dark:hover:bg-electric-blue/20 transition-all cursor-pointer"
                    >
                      ...
                      <span
                        className="mt-1 flex min-w-0 items-center gap-1.5 text-sm text-electric-blue hover:underline dark:text-electric-blue"
                        onClick={(e) => {
                          e.stopPropagation();
